...
% However, the skewness and kurtosis actually degrade as compared to the pre-destriping distribution \Chris{they are normalized to the $\sigma$, so the ``absolute'' 3rd and 4th moments have been reduced.}. 
...
% attribute this fact to the the fact that the correlated $1/f$ noise stripes are so dominant over all other sources. After destriping, additional  background effects like sky background will become more dominant in the distribution. An overall skew or kurtosis to the distribution might indicate a gradient of zodiacal light in the image or some other sky effect. . After removing the dominant \textit{1/f} noise, those varying sky levels become detectable.
